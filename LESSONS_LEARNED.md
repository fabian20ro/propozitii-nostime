...
- 2026-02-19: Pre-existing edge case: "negru"→"neagră" requires a stem vowel alternation (e→ea) that simple suffix rules cannot handle; currently produces incorrect "negră".
