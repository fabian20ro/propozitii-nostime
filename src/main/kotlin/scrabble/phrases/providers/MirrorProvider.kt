...
class MirrorProvider(
    ...
    override fun getSentence(): String {
        val rhymes = repo.findTwoRhymeGroups("V", 2, maxRarity = maxRarity)
        ...
        val verb1 = repo.getRandomVerbByRhyme(rhymeA, maxRarity = maxRarity)
        ...
        val verb2 = repo.getRandomVerbByRhyme(rhymeB, maxRarity = maxRarity, exclude = usedVerbs)
        ...
        val verb3 = repo.getRandomVerbByRhyme(rhymeB, maxRarity = maxRarity, exclude = usedVerbs)
        ...
        val verb4 = repo.getRandomVerbByRhyme(rhymeA, maxRarity = maxRarity, exclude = usedVerbs)
