...
class MirrorProvider(private val repo: WordRepository) : ISentenceProvider {
    ...
    override fun getSentence(): String {
        val rhymes = repo.findTwoRhymeGroups("V", 2)
        ...
        val verb1 = repo.getRandomVerbByRhyme(rhymeA)
        ...
        val verb2 = repo.getRandomVerbByRhyme(rhymeB, exclude = usedVerbs)
        ...
        val verb3 = repo.getRandomVerbByRhyme(rhymeB, exclude = usedVerbs)
        ...
        val verb4 = repo.getRandomVerbByRhyme(rhymeA, exclude = usedVerbs)
